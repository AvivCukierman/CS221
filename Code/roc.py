...
for x in xs:
  filename = options.inputDir+'/'+options.inputResults+str(x)+'_tjets.txt'
...
fig.savefig(options.plotDir+'/roc_error.png')
###
...
plt.legend(loc='upper right',frameon=False,numpoints=1)
ax.set_yscale('log')
fig.savefig(options.plotDir+'/roc_error_log.png')
###
...
plt.legend(loc='upper right',frameon=False,numpoints=1)
fig.savefig(options.plotDir+'/roc_pt_error.png')
###
...
#ax.set_xscale('log')
ax.set_yscale('log')
fig.savefig(options.plotDir+'/roc_pt_error_log.png')
###
